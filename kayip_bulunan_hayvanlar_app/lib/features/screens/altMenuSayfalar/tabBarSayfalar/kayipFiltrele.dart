...
class KayipFiltrele extends StatefulWidget {
  const KayipFiltrele({super.key});

  @override
  State<KayipFiltrele> createState() => _KayipFiltreleState();
}

class _KayipFiltreleState extends State<KayipFiltrele> {
  @override
...
class _FilterScreenState extends State<FilterScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text(
          'Kayıp Hayvan Filtreleme Ekranı',
                  ...
                  child: ElevatedButton(
                    onPressed: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => const KayipFiltrele(),
                        ),
                      );
                    },
