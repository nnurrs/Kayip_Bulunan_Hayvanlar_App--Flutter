...
import 'package:kayip_bulunan_hayvanlar_app/features/screens/altMenuSayfalar/tabBarSayfalar/kayipFiltrele.dart';
import 'package:kayip_bulunan_hayvanlar_app/features/screens/firestore/kayipform.dart';
import 'package:cloud_firestore/cloud_firestore.dart';

class Kayip extends StatefulWidget {
  const Kayip({super.key});

  @override
  State<Kayip> createState() => _KayipState();
}

class _KayipState extends State<Kayip> {
  ...
  Future<void> getDocuments() async {
    QuerySnapshot querySnapshot =
        await FirebaseFirestore.instance.collection('kayıp').get();
    ...
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () {
          Navigator.push(
            context,
            MaterialPageRoute(builder: (context) => const KayipForm()),
          );
        },
          ...
          children: <Widget>[
            ...
            if (filteredDocuments.isNotEmpty)
              ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  DateTime? tarih = data != null && data['kayıptarih'] != null
            ...
            if (filteredDocuments.isEmpty)
              const Padding(
                ...
                child: Text(
                  'Arama kriterlerine uygun kayıp hayvan ilanı bulunamadı.',
                  style: TextStyle(
                    fontSize: 18,
                    fontWeight: FontWeight.bold,
                    fontFamily: 'aptosbold',
